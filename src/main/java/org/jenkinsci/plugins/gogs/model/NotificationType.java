...
import org.jenkinsci.plugins.gogs.HipChatNotifier.DescriptorImpl;
...
public enum NotificationType {
    ...
    Notification getNotification(NotificationConfig config, AbstractBuild<?, ?> build, BuildListener buildListener,
        ...
        String messageTemplate = Util.replaceMacro(config.getMessageTemplate(), ImmutableMap.of(Constants.STATUS, getStatus()));
